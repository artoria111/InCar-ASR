...
export PATH="$ASCEND_HOME/bin:$ASCEND_HOME/atc/bin:$ASCEND_HOME/atc/ccec_compiler/bin:$PATH"
export PYTHONPATH="$ASCEND_HOME/python/site-packages:$ASCEND_HOME/pyACL/python/site-packages/acl:${PYTHONPATH:-}"
