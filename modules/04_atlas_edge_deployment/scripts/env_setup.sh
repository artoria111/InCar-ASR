...
export ASCEND_HOME="${ASCEND_HOME:-/usr/local/Ascend/ascend-toolkit/latest}"
export LITE_HOME="${LITE_HOME:-/home/mindspore-lite-2.2.10-linux-aarch64}"

# AscendCL
export LD_LIBRARY_PATH="$ASCEND_HOME/lib64:$ASCEND_HOME/runtime/lib64:$ASCEND_HOME/acllib/lib64:${LD_LIBRARY_PATH:-}"
...
echo "[env_setup] ATC=$(command -v atc 2>/dev/null || echo 'not found')"
